	...
	namespace Api
	{
		namespace Responses
		{
			...
			*/
			...
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrencies () const
					{
						return m_Response.GetGSDataObject("currencies");
					}
			/// <summary>
			/// The amount of type 1 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency1 () const
					{
						return m_Response.GetLongLong("currency1");
					}
			/// <summary>
			/// The amount of type 2 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency2 () const
					{
						return m_Response.GetLongLong("currency2");
					}
			/// <summary>
			/// The amount of type 3 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency3 () const
					{
						return m_Response.GetLongLong("currency3");
					}
			/// <summary>
			/// The amount of type 4 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency4 () const
					{
						return m_Response.GetLongLong("currency4");
					}
			/// <summary>
			/// The amount of type 5 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency5 () const
					{
						return m_Response.GetLongLong("currency5");
					}
			/// <summary>
			/// The amount of type 6 currency that the player holds
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency6 () const
					{
						return m_Response.GetLongLong("currency6");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetReservedCurrencies () const
					{
						return m_Response.GetGSDataObject("reservedCurrencies");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrenciesAdded () const
					{
						return m_Response.GetGSDataObject("currenciesAdded");
					}
			/// <summary>
			/// How much currency type 1 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency1Added () const
					{
						return m_Response.GetLongLong("currency1Added");
					}
			/// <summary>
			/// How much currency type 2 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency2Added () const
					{
						return m_Response.GetLongLong("currency2Added");
					}
			/// <summary>
			/// How much currency type 3 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency3Added () const
					{
						return m_Response.GetLongLong("currency3Added");
					}
			/// <summary>
			/// How much currency type 4 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency4Added () const
					{
						return m_Response.GetLongLong("currency4Added");
					}
			/// <summary>
			/// How much currency type 5 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency5Added () const
					{
						return m_Response.GetLongLong("currency5Added");
					}
			/// <summary>
			/// How much currency type 6 was added
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency6Added () const
					{
						return m_Response.GetLongLong("currency6Added");
					}
			/// <summary>
			/// For a buy with currency request, how much currency was used
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrencyConsumed () const
					{
						return m_Response.GetLongLong("currencyConsumed");
					}
			/// <summary>
			/// For a buy with currency request, the short code of the currency used
			/// </summary>
					// method type 4
					Optional::t_StringOptional GetCurrencyShortCode () const
					{
						return m_Response.GetString("currencyShortCode");
					}
			/// <summary>
			...
			/// </summary>
						gsstl::vector<gsstl::string> GetInvalidItems() const
						{
							return m_Response.GetStringList("invalidItems");
						}
			/// <summary>
			...
			*/
			...
			A response to a dismiss message request
			*/
			class DismissMultipleMessagesResponse : public  GameSparks::Core::GSTypedResponse
			{
			public:
				DismissMultipleMessagesResponse(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{

				}

				DismissMultipleMessagesResponse(const DismissMultipleMessagesResponse& other)
					: GSTypedResponse(other)
				{
				}
			...
			/// </summary>
						gsstl::vector<gsstl::string> GetFailedDismissals() const
						{
							return m_Response.GetStringList("failedDismissals");
						}
			/// <summary>
			/// An integer describing how many messages were dismissed
			/// </summary>
					// method type 4
					Optional::t_IntOptional GetMessagesDismissed () const
					{
						return m_Response.GetInt("messagesDismissed");
					}
			};
			/*!
			\ingroup Teams
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSessionDuration () const
					{
						return m_Response.GetLongLong("sessionDuration");
					}
			};
			/*!
			\ingroup Multiplayer
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSize () const
					{
						return m_Response.GetLongLong("size");
					}
			/// <summary>
			/// The download URL
			/// </summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_StringOptional GetStatus () const
					{
						return m_Response.GetString("status");
					}
			};
			/*!
			\ingroup Teams
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_BoolOptional GetJoined () const
					{
						return m_Response.GetBoolean("joined");
					}
			};
			/*!
			\ingroup Multiplayer
			...
			*/
			class ListMessageDetailResponse : public  GameSparks::Core::GSTypedResponse
			{
			public:
				ListMessageDetailResponse(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{

				}

				ListMessageDetailResponse(const ListMessageDetailResponse& other)
					: GSTypedResponse(other)
				{
				}
			...
			/// </summary>
					// method type 1
					gsstl::vector<Types::PlayerMessage> GetMessageList() const
					{
						gsstl::vector<Types::PlayerMessage> result;
						gsstl::vector<GameSparks::Core::GSData> dataList = m_Response.GetGSDataObjectList("messageList");
						for (gsstl::vector<GameSparks::Core::GSData>::iterator it = dataList.begin(); it != dataList.end(); ++it)
						{
							result.push_back(Types::PlayerMessage(*it));
						}
						return result; 
					}
			};
			...
			*/
			...
			/// </summary>
					// method type 1
					gsstl::vector<Types::ChatMessage> GetMessages() const
					{
						gsstl::vector<Types::ChatMessage> result;
						gsstl::vector<GameSparks::Core::GSData> dataList = m_Response.GetGSDataObjectList("messages");
						for (gsstl::vector<GameSparks::Core::GSData>::iterator it = dataList.begin(); it != dataList.end(); ++it)
						{
							result.push_back(Types::ChatMessage(*it));
						}
						return result; 
					}
			};
			...
			*/
			class ListTeamsResponse : public  GameSparks::Core::GSTypedResponse
			{
			public:
				ListTeamsResponse(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{

				}

				ListTeamsResponse(const ListTeamsResponse& other)
					: GSTypedResponse(other)
				{
				}
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetEstimatedCount () const
					{
						return m_Response.GetLongLong("estimatedCount");
					}
			/// <summary>
			...
			*/
			class UpdateMessageResponse : public  GameSparks::Core::GSTypedResponse
			{
			public:
				UpdateMessageResponse(const GameSparks::Core::GSData& data)
					: GSTypedResponse(data)
				{

				}

				UpdateMessageResponse(const UpdateMessageResponse& other)
					: GSTypedResponse(other)
				{
				}
